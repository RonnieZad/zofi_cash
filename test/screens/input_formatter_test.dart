...
main() {
  group('Test Text Format', () {
    test('Test text formatter when there is no user input', () {
      var digit1 = Helper.getTextDigit('');
      expect(digit1, "0");
    });
    test('Test text formatter when user enters random value > 1000', () {
    ...
    test('Test text formatter when user enters decimal value', () {
